...
-- 1. Consulta Simples: Listar alunos e seus respectivos cursos
SELECT a.nome_aluno, c.nome_curso 
FROM tb_alunos a
JOIN tb_cursos c ON a.fk_id_curso = c.pk_id_curso;

-- 2. Subselect com Agregação: Alunos com contratos acima da média geral
...
-- 3. Subselect Correlacionado: Disciplinas que têm carga horária maior ou igual à média da faculdade
SELECT d1.nome_disciplina, d1.carga_horaria
