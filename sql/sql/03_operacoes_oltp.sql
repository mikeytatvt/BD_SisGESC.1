...
-- 1. Consulta Simples com Filtro (Atende critério de filtros e domínio operacional)
...
-- 2. Subselect com Agregação (Atende critério de agregação)
...
-- 3. Subselect Correlacionado (Atende critério de correlação/nível avançado)
-- Lista disciplinas com carga horária acima da média do seu próprio status
...
WHERE d1.carga_horaria >= (
    ...
    WHERE d2.status_disciplina = d1.status_disciplina
); [cite: 84]
