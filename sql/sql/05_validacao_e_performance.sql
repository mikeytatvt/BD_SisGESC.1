...
-- 2. Performance: EXPLAIN ANTES da otimização (Mostra o custo alto inicial) [cite: 109]
...
-- 4. Performance: EXPLAIN DEPOIS da otimização (Prova o ganho de velocidade) [cite: 109]
EXPLAIN SELECT * FROM fato_financeiro WHERE fk_tempo = 1;
